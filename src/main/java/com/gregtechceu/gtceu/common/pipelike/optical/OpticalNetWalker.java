...
public class OpticalNetWalker extends PipeNetWalker<OpticalPipeBlockEntity, OpticalPipeProperties, OpticalPipeNet> {
    ...
    protected void checkNeighbour(OpticalPipeBlockEntity pipeTile, BlockPos pipePos, Direction faceToNeighbour,
        ...
        if (((OpticalNetWalker) root).routePath == null) {
            if ((com.gregtechceu.gtceu.api.capability.GTCapabilityHelper.getBlockEntityCapability(neighbourTile, GTCapability.CAPABILITY_DATA_ACCESS, faceToNeighbour.getOpposite()) != null) ||
                    (com.gregtechceu.gtceu.api.capability.GTCapabilityHelper.getBlockEntityCapability(neighbourTile, GTCapability.CAPABILITY_COMPUTATION_PROVIDER, faceToNeighbour.getOpposite()) != null)) {
