...
public interface IArmorLogic {
    ...
    EnumMap<ArmorType, UUID> ARMOR_MODIFIER_UUID_PER_TYPE = Util.make(new EnumMap<>(ArmorType.class), map -> {
        map.put(ArmorType.BOOTS, UUID.fromString("be2b5c6e-bb5d-4675-a6be-c6c488a437f5"));
        map.put(ArmorType.LEGGINGS, UUID.fromString("435c34aa-0c5b-442d-abb0-d1c984c894f9"));
        map.put(ArmorType.CHESTPLATE, UUID.fromString("77d81693-63cc-4593-977d-8e0391d94a77"));
        map.put(ArmorType.HELMET, UUID.fromString("cc839692-3a33-4907-a114-21fa0a18184c"));
    });
