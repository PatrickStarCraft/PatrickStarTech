...
public final class OreRecipeHandler {
    ...
    private static void processMetalSmelting(@NotNull Consumer<GeneratedRecipe> provider, @NotNull OreProperty property,
    ...
    private static void processOre(@NotNull Consumer<GeneratedRecipe> provider, @NotNull TagPrefix orePrefix,
    ...
    private static void processRawOre(@NotNull Consumer<GeneratedRecipe> provider, @NotNull OreProperty property,
    ...
    private static void processCrushedOre(@NotNull Consumer<GeneratedRecipe> provider, @NotNull OreProperty property,
                                          @NotNull Material material) {
    ...
    private static void processCrushedCentrifuged(@NotNull Consumer<GeneratedRecipe> provider,
                                                  @NotNull OreProperty property, @NotNull Material material) {
    ...
    private static void processCrushedPurified(@NotNull Consumer<GeneratedRecipe> provider,
    ...
    private static void processDirtyDust(@NotNull Consumer<GeneratedRecipe> provider, @NotNull OreProperty property,
                                         @NotNull Material material) {
    ...
    private static void processPureDust(@NotNull Consumer<GeneratedRecipe> provider, @NotNull OreProperty property,
                                        @NotNull Material material) {
