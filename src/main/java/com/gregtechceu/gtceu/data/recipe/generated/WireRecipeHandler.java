...
public final class WireRecipeHandler {
    ...
    private static void processWires(@NotNull Consumer<GeneratedRecipe> provider, @NotNull Material material) {
    ...
    private static void generateCableCovering(@NotNull Consumer<GeneratedRecipe> provider,
    ...
    private static void generateManualRecipe(@NotNull Consumer<GeneratedRecipe> provider, @NotNull TagPrefix wirePrefix,
